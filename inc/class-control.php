...
class Haricot_Control {
	...
	public function get_field_name( $setting = 'default' ) {
		...
		return "haricot_{$this->manager->name}_setting_{$this->settings[ $setting ]}";
	}
	...
	public function is_active() {
		...
		return apply_filters( 'haricot_is_control_active', $is_active, $this );
	}
	...
	public function print_template() { ?>
		...
		<script type="text/html" id="tmpl-haricot-control-<?php echo esc_attr( $this->type ); ?>">
	...
	public function get_template() {
		haricot_get_control_template( $this->type );
	}
}
